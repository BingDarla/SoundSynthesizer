  ...
  return function(t) {
    ...
    return e.prototype.toString = function() {
        ...
        if (i = t[o], r = this, -1 !== o.indexOf(".")) {
          for (a = o.split("."), l = 0; l < a.length - 1; l++)
            if ((r = r[a[l]]) instanceof e) {
              a.splice(0, l + 1), h = a.join("."), r.set(h, i);
              continue t
            }
          o = a[a.length - 1]
        }
        u = r[o], e.isUndef(u) || (e.Signal && u instanceof e.Signal || e.Param && u instanceof e.Param ? u.value !== i && (e.isUndef(n) ? u.value = i : u.rampTo(i, n)) : u instanceof AudioParam ? u.value !== i && (u.value = i) : u instanceof e ? u.set(i) : u !== i && (r[o] = i))
      }
      return this
    }, e.prototype.get = function(t) {
      var i, n, s, o, r, a, l, h, u;
      for (e.isUndef(t) ? t = this._collectDefaults(this.constructor) : e.isString(t) && (t = [t]), i = {}, n = 0; n < t.length; n++) {
        if (s = t[n], o = this, r = i, -1 !== s.indexOf(".")) {
          for (a = s.split("."), l = 0; l < a.length - 1; l++) h = a[l], r[h] = r[h] || {}, r = r[h], o = o[h];
          s = a[a.length - 1]
        }
        u = o[s], e.isObject(t[s]) ? r[s] = u.get() : e.Signal && u instanceof e.Signal ? r[s] = u.value : e.Param && u instanceof e.Param ? r[s] = u.value : u instanceof AudioParam ? r[s] = u.value : u instanceof e ? r[s] = u.get() : e.isFunction(u) || e.isUndef(u) || (r[s] = u)
      }
      return i
    }, e.prototype._collectDefaults = function(t) {
      var i, n, s = [];
      if (e.isUndef(t.defaults) || (s = Object.keys(t.defaults)), !e.isUndef(t._super))
      ...
      return e.isUndef(n.defaults) ? e.isObject(n) ? e.defaultArg(o, n) : o : e.defaultArg(o, n.defaults)
      ...
      t < e.context.currentTime && console.warn("Time '" + t + "' is in the past. Scheduled time must be ≥ AudioContext.currentTime")
      ...
      return e
    }, e.version = "r11", window.TONE_SILENCE_VERSION_LOGGING || console.log("%c * Tone.js " + e.version + " * ", "background: #000; color: #fff"), e
  }), t(function(t) {
    return t.Emitter = function() {
      ...
      if (this._events && (e = Array.apply(null, arguments).slice(1), this._events.hasOwnProperty(t)))
        for (i = this._events[t], n = 0, s = i.length; n < s; n++) i[n].apply(this, e);
      return this
    }, t.Emitter.mixin = function(e) {
      var i, n, s, o = ["on", "off", "emit"];
    ...
    return t.Timeline = function() {
      ...
      t.call(this), this._timeline = [], this._toRemove = [], this._toAdd = [], this._iterating = !1, this.memory = e.memory
      ...
      return this._iterating ? this._toAdd.push(e) : (i = this._search(e.time), this._timeline.splice(i + 1, 0, e), this.length > this.memory && (n = this.length - this.memory, this._timeline.splice(0, n))), this
      ...
      for (; n < o;) {
        if (r = Math.floor(n + (o - n) / 2), a = this._timeline[r], l = this._timeline[r + 1], a[i] === e) {
          for (h = r; h < this._timeline.length; h++) u = this._timeline[h], u[i] === e && (r = h);
          return r
        }
      ...
      this._iterating = !0, i = t.defaultArg(i, 0), n = t.defaultArg(n, this._timeline.length - 1);
      for (var s = i; s <= n; s++) e.call(this, this._timeline[s]);
      this._iterating = !1, this._toRemove.forEach(function(t) {
        this.remove(t)
      }.bind(this)), this._toRemove = [], this._toAdd.forEach(function(t) {
        this.add(t)
      }.bind(this)), this._toAdd = []
      ...
      return t.prototype.dispose.call(this), this._timeline = null, this._toRemove = null, this._toAdd = null, this
    }, t.Timeline
  }), t(function(t) {
    !window.hasOwnProperty("AudioContext") && window.hasOwnProperty("webkitAudioContext") && (window.AudioContext = window.webkitAudioContext), t.Context = function() {
      var i, n;
      t.Emitter.call(this), i = t.defaults(arguments, ["context"], t.Context), i.context || (i.context = new window.AudioContext), this._context = i.context;
      ...
      t.Context.emit("close", this), t.Emitter.prototype.dispose.call(this), this._ticker.dispose(), this._ticker = null, this._timeouts.dispose(), this._timeouts = null;
      for (var e in this._constants) this._constants[e].disconnect();
      return this._constants = null, this.close(), this
    };
    ...
    return e.Type = {
      ...
      function e(e, i, s) {
        if (e.input) s = t.defaultArg(s, 0), t.isArray(e.input) ? this.connect(e.input[s]) : this.connect(e.input, i, s);
        else try {
    ...
    }), t.supported ? t.context = new t.Context : console.warn("This browser does not support Tone.js"), t.Context
  }), t(function(t) {
    return t.AudioNode = function() {
      ...
      return t.isUndef(this.input) || (this.input instanceof AudioNode && this.input.disconnect(), this.input = null), t.isUndef(this.output) || (this.output instanceof AudioNode && this.output.disconnect(), this.output = null), this._context = null, this
    }, t.AudioNode
  }), t(function(t) {
    return t.SignalBase = function() {
      ...
      return t.Signal && t.Signal === e.constructor || t.Param && t.Param === e.constructor || t.TimelineSignal && t.TimelineSignal === e.constructor ? (e._param.cancelScheduledValues(0), e._param.value = 0, e.overridden = !0) : e instanceof AudioParam && (e.cancelScheduledValues(0), e.value = 0), t.AudioNode.prototype.connect.call(this, e, i, n), this
    }, t.SignalBase
  }), t(function(t) {
    return t.WaveShaper = function(e, i) {
      ...
      var e, i, n;
      for (e = 0, i = this._curve.length; e < i; e++) n = e / (i - 1) * 2 - 1, this._curve[e] = t(n, e);
    ...
    return t.TimeBase = function(e, i) {
      ...
      } else t.isString(e) ? this.set(e) : t.isUndef(e) && (this._expr = this._defaultExpr())
      ...
      for (var e, i = -1, n = []; t.length > 0;) t = t.trim(), e = function(t, e) {
        var i, n, s, o, r, a, l = ["_binaryExpressions", "_unaryExpressions", "_primaryExpressions", "_syntaxGlue"];
      ...
      }(t, this), n.push(e), t = t.substr(e.value.length);
      return {
        next: function() {
          return n[++i]
        },
      ...
      if (!t.isUndef(e))
        for (s in i)
          if (o = i[s], o.regexp.test(e.value)) {
            if (t.isUndef(n)) return o;
            if (o.precedence === n) return o
          }
      return r
    }, t.TimeBase.prototype._parseBinary = function(e, i) {
      var n, s;
      for (t.isUndef(i) && (i = 2), n = i < 0 ? this._parseUnary(e) : this._parseBinary(e, i - 1), s = e.peek(); s && this._matchGroup(s, this._binaryExpressions, i);) s = e.next(), n = s.method.bind(this, n, this._parseBinary(e, i - 1)), s = e.peek();
      return n
    }, t.TimeBase.prototype._parseUnary = function(t) {
      var e, i = t.peek(),
        n = this._matchGroup(i, this._unaryExpressions);
      return n ? (i = t.next(), e = this._parseUnary(t), n.method.bind(this, e)) : this._parsePrimary(t)
    }, t.TimeBase.prototype._parsePrimary = function(e) {
      var i, n, s = e.peek();
      if (t.isUndef(s)) throw new SyntaxError("Tone.TimeBase: Unexpected end of expression");
      if (this._matchGroup(s, this._primaryExpressions)) return s = e.next(), n = s.value.match(s.regexp), s.method.bind(this, n[1], n[2], n[3]);
      if (s && "(" === s.value) {
        if (e.next(), i = this._parseBinary(e), !(s = e.next()) || ")" !== s.value) throw new SyntaxError("Expected )");
        return i
      }
      throw new SyntaxError("Tone.TimeBase: Cannot process token " + s.value)
    }, t.TimeBase.prototype._parseExprString = function(e) {
      var i;
      return t.isString(e) || (e = e.toString()), i = this._tokenize(e), this._parseBinary(i)
    ...
    return t.Time = function(e, i) {
      ...
      return i = t.defaultArg(i, 1), this._expr = function(t, e, i) {
        var n, s, o;
        return t = t(), e = e.toSeconds(), n = Math.round(t / e), s = n * e, o = s - t, t + o * i
      }.bind(this, this._expr, new this.constructor(e), i), this
      ...
      var i, n, s, o, r = this._notationToUnits(e[e.length - 1]),
        a = "";
      for (i = 0; i < e.length; i++)
        if (n = this._notationToUnits(e[i]), s = t / n, o = 1e-6, 1 - s % 1 < o && (s += o), (s = Math.floor(s)) > 0) {
          if (a += 1 === s ? e[i] : s.toString() + "*" + e[i], (t -= s * n) < r) break;
          a += " + "
        }
      return "" === a && (a = "0"), a
    }, t.Time.prototype._notationToUnits = function(t) {
      var e, i, n, s = this._primaryExpressions,
        o = [s.n, s.t, s.m];
      for (e = 0; e < o.length; e++)
        if (i = o[e], n = t.match(i.regexp)) return i.method.call(this, n[1])
    }, t.Time.prototype.toBarsBeatsSixteenths = function() {
      var t, e = this._beatsToUnits(1),
        i = this.toSeconds() / e,
        n = Math.floor(i / this._timeSignature()),
        s = i % 1 * 4;
      return i = Math.floor(i) % this._timeSignature(), s = s.toString(), s.length > 3 && (s = parseFloat(parseFloat(s).toFixed(3))), t = [n, i, s], t.join(":")
    ...
    return t.Frequency = function(e, i) {
      ...
      return this._expr = function(e, i) {
        var n, s = e(),
          o = [];
        for (n = 0; n < i.length; n++) o[n] = s * t.intervalToFrequencyRatio(i[n]);
        return o
      }.bind(this, this._expr, e), this
      ...
      "b#": 12,
      bx: 13
    }, i = ["C", "C#", "D", "D#", "E", "F", "F#", "G", "G#", "A", "A#", "B"], t.Frequency.A4 = 440, t.Frequency.prototype.midiToFrequency = function(e) {
    ...
    return t.Param = function() {
      ...
      t.AudioNode.call(this), this._param = this.input = e.param, this.units = e.units, this.convert = e.convert, this.overridden = !1, this._lfo = null, t.isObject(e.lfo) ? this.value = e.lfo : t.isUndef(e.value) || (this.value = e.value)
      ...
      set: function(e) {
        if (t.isObject(e)) {
          if (t.isUndef(t.LFO)) throw new Error("Include 'Tone.LFO' to use an LFO as a Param value.");
    ...
    }, t.Param.prototype._minOutput = 1e-5, t.Param.prototype.setValueAtTime = function(e, i) {
      return i = this.toSeconds(i), t.isPast(i), this._param.setValueAtTime(this._fromUnits(e), i), this
    }, t.Param.prototype.setRampPoint = function(e) {
      e = t.defaultArg(e, this.now()), this.cancelAndHoldAtTime(this.context.currentTime);
      var i = this._param.value;
      return 0 === i && (i = this._minOutput), this._param.setValueAtTime(i, e), this
    }, t.Param.prototype.linearRampToValueAtTime = function(e, i) {
      return e = this._fromUnits(e), i = this.toSeconds(i), t.isPast(i), this._param.linearRampToValueAtTime(e, i), this
    }, t.Param.prototype.exponentialRampToValueAtTime = function(e, i) {
      return e = this._fromUnits(e), e = Math.max(this._minOutput, e), i = this.toSeconds(i), t.isPast(i), this._param.exponentialRampToValueAtTime(e, i), this
    ...
    }, t.Param.prototype.getTimeConstant = function(t) {
      return Math.log(this.toSeconds(t) + 1) / Math.log(200)
    }, t.Param.prototype.targetRampTo = function(t, e, i) {
      return i = this.toSeconds(i), this.setRampPoint(i), this.setTargetAtTime(t, i, this.getTimeConstant(e)), this
      ...
      var n, s;
      for (i = this.toSeconds(i), e = this.toSeconds(e), this.setValueAtTime(t[0], e), n = i / (t.length - 1), s = 1; s < t.length; s++) this._param.linearRampToValueAtTime(this._fromUnits(t[s]), e + s * n);
      return this
      ...
      var e, i;
      return t = this.toSeconds(t), this._param.cancelAndHoldAtTime ? this._param.cancelAndHoldAtTime(t) : (e = this.context.currentTime, this._param.cancelScheduledValues(e), i = this._param.value, 0 === i && (i = this._minOutput), this._param.setValueAtTime(i, e + this.sampleTime)), this
      ...
      return t.AudioNode.prototype.dispose.call(this), this._param = null, this._lfo && (this._lfo.dispose(), this._lfo = null), this
    }, t.Param
  }), t(function(t) {
    ...
    return t.Signal = function() {
      ...
      e.param = i.gain, t.Param.call(this, e), this.output = i, this.input = this._param = this.output.gain, this.context.getConstant(1).connect(this.output)
    ...
    return t.TimelineSignal = function() {
      var e = t.defaults(arguments, ["value", "units"], t.Signal);
      t.Signal.call(this, e), this._events = new t.Timeline(100), this._initial = this._fromUnits(this._param.value), this.value = e.value, delete this.input
    }, t.extend(t.TimelineSignal, t.Signal), t.TimelineSignal.Type = {
      Linear: "linear",
      ...
      var n, s;
      return i = this.toSeconds(i), n = this._searchBefore(i), n && 0 === n.value && this.setValueAtTime(this._minOutput, n.time), e = this._fromUnits(e), s = Math.max(e, this._minOutput), this._events.add({
      ...
      var o, r;
      for (s = t.defaultArg(s, 1), n = this.toSeconds(n), i = this.toSeconds(i), o = n / (e.length - 1), this.setValueAtTime(e[0] * s, i), r = 1; r < e.length; r++) this.linearRampToValueAtTime(e[r] * s, i + r * o);
      return this
      ...
      var i, n, s;
      return e = this.toSeconds(e), i = this._toUnits(this.getValueAtTime(e)), n = this._searchBefore(e), n && n.time === e ? this.cancelScheduledValues(e + this.sampleTime) : (s = this._searchAfter(e)) && (this.cancelScheduledValues(e), s.type === t.TimelineSignal.Type.Linear ? this.linearRampToValueAtTime(i, e) : s.type === t.TimelineSignal.Type.Exponential && this.exponentialRampToValueAtTime(i, e)), this.setValueAtTime(i, e), this
      ...
      var i, n, s, o, r;
      return e = this.toSeconds(e), i = this._searchAfter(e), n = this._searchBefore(e), s = this._initial, null === n ? s = this._initial : n.type === t.TimelineSignal.Type.Target ? (o = this._events.getBefore(n.time), r = null === o ? this._initial : o.value, s = this._exponentialApproach(n.time, r, n.value, n.constant, e)) : s = null === i ? n.value : i.type === t.TimelineSignal.Type.Linear ? this._linearInterpolate(n.time, n.value, i.time, i.value, e) : i.type === t.TimelineSignal.Type.Exponential ? this._exponentialInterpolate(n.time, n.value, i.time, i.value, e) : n.value, s
      ...
      t.Signal.prototype.dispose.call(this), this._events.dispose(), this._events = null
    }, t.TimelineSignal
  }), t(function(t) {
    ...
    return t.Envelope = function() {
        ...
        t.AudioNode.call(this), this.attack = e.attack, this.decay = e.decay, this.sustain = e.sustain, this.release = e.release, this._attackCurve = "linear", this._releaseCurve = "exponential", this._sig = this.output = new t.TimelineSignal, this._sig.setValueAtTime(0, 0), this.attackCurve = e.attackCurve, this.releaseCurve = e.releaseCurve
        ...
        return e = this.toSeconds(e), n = this.toSeconds(this.attack), s = n, o = this.toSeconds(this.decay), i = t.defaultArg(i, 1), r = this.getValueAtTime(e), r > 0 && (a = 1 / s, l = 1 - r, s = l / a), "linear" === this._attackCurve ? this._sig.linearRampTo(i, s, e) : "exponential" === this._attackCurve ? this._sig.targetRampTo(i, s, e) : s > 0 && (this._sig.setRampPoint(e), h = this._attackCurve, s < n && (u = 1 - s / n, c = Math.floor(u * this._attackCurve.length), h = this._attackCurve.slice(c), h[0] = r), this._sig.setValueCurveAtTime(h, e, s, i)), this._sig.targetRampTo(i * this.sustain, o, s + e), this
      }, t.Envelope.prototype.triggerRelease = function(e) {
        var i, n, s;
        return e = this.toSeconds(e), i = this.getValueAtTime(e), i > 0 && (n = this.toSeconds(this.release), "linear" === this._releaseCurve ? this._sig.linearRampTo(0, n, e) : "exponential" === this._releaseCurve ? this._sig.targetRampTo(0, n, e) : (s = this._releaseCurve, t.isArray(s) && (this._sig.setRampPoint(e), this._sig.setValueCurveAtTime(s, e, n, i)))), this
      ...
      function() {
        ...
        var i, n, s, o, r, a, l, h, u, c, p, f = 128,
          d = [];
        for (i = 0; i < f; i++) d[i] = Math.sin(i / (f - 1) * (Math.PI / 2));
        for (s = [], o = 6.4, i = 0; i < f - 1; i++) n = i / (f - 1), r = Math.sin(n * (2 * Math.PI) * o - Math.PI / 2) + 1, s[i] = r / 10 + .83 * n;
        for (s[f - 1] = 1, a = [], l = 5, i = 0; i < f; i++) a[i] = Math.ceil(i / (f - 1) * l) / l;
        for (h = [], i = 0; i < f; i++) n = i / (f - 1), h[i] = .5 * (1 - Math.cos(Math.PI * n));
        for (u = [], i = 0; i < f; i++) n = i / (f - 1), c = 4 * Math.pow(n, 3) + .2, p = Math.cos(c * Math.PI * 2 * n), u[i] = Math.abs(p * (1 - n));
        t.Envelope.Type = {
          linear: "linear",
          exponential: "exponential",
          bounce: {
    ...
    return t.Multiply = function(e) {
      t.Signal.call(this), this.createInsOuts(2, 0), this._mult = this.input[0] = this.output = new t.Gain, this._param = this.input[1] = this.output.gain, this._param.value = t.defaultArg(e, 0)
    ...
    return t.Expr = function() {
      var e, i, n, s, o;
      for (t.SignalBase.call(this), e = this._replacements(Array.prototype.slice.call(arguments)), i = this._parseInputs(e), this._nodes = [], this.input = new Array(i), n = 0; n < i; n++) this.input[n] = this.context.createGain();
      s = this._parseTree(e);
      try {
        o = this._eval(s)
      } catch (t) {
        throw this._disposeNodes(), new Error("Tone.Expr: Could evaluate expression: " + e)
      }
      this.output = o
      ...
      var e, i, n = t.match(/\$\d/g),
        s = 0;
      if (null !== n)
        for (e = 0; e < n.length; e++) i = parseInt(n[e].substr(1)) + 1, s = Math.max(s, i);
      return s
      ...
      for (var i, n = -1, s = []; e.length > 0;) e = e.trim(), i = function(e) {
        var i, n, s, o, r, a;
        for (i in t.Expr._Expressions) {
          n = t.Expr._Expressions[i];
          for (s in n)
            if (o = n[s], r = o.regexp, null !== (a = e.match(r))) return {
              type: i,
              value: a[0],
              method: o.method
            }
      ...
      }(e), s.push(i), e = e.substr(i.value.length);
      return {
        next: function() {
          return s[++n]
        },
      ...
      function n(e, i, n) {
        ...
        if (!u(e))
          for (s in a)
            if (o = a[s], o.regexp.test(e.value)) {
              if (u(n)) return !0;
      ...
      function s(t) {
        var e, i;
        for (u(t) && (t = 5), e = t < 0 ? o() : s(t - 1), i = h.peek(); n(i, "binary", t);) i = h.next(), e = {
          operator: i.value,
          method: i.method,
          args: [e, s(t - 1)]
        }, i = h.peek();
      ...
      function o() {
        var t, e;
        return t = h.peek(), n(t, "unary") ? (t = h.next(), e = o(), {
          operator: t.value,
          method: t.method,
          args: [e]
        }) : r()
      ...
      var h = this._tokenize(e),
        u = t.isUndef.bind(this);
      return s()
    }, t.Expr.prototype._eval = function(e) {
      if (!t.isUndef(e)) {
        var i = e.method(e.args, this);
        return this._nodes.push(i), i
      }
    }, t.Expr.prototype._disposeNodes = function() {
      var e, i;
      for (e = 0; e < this._nodes.length; e++) i = this._nodes[e], t.isFunction(i.dispose) ? i.dispose() : t.isFunction(i.disconnect) && i.disconnect(), i = null, this._nodes[e] = null;
      this._nodes = null
    }, t.Expr.prototype.dispose = function() {
      t.SignalBase.prototype.dispose.call(this), this._disposeNodes()
    }, t.Expr
  }), t(function(t) {
    ...
    return t.CrossFade = function(e) {
      ...
      return t.AudioNode.prototype.dispose.call(this), this._writable("fade"), this._equalPowerA.dispose(), this._equalPowerA = null, this._equalPowerB.dispose(), this._equalPowerB = null, this.fade.dispose(), this.fade = null, this._invert.dispose(), this._invert = null, this.a.dispose(), this.a = null, this.b.dispose(), this.b = null, this
    }, t.CrossFade
  }), t(function(t) {
    ...
    return window.DelayNode && !AudioContext.prototype.createDelay && (AudioContext.prototype.createDelay = AudioContext.prototype.createDelayNode), t.Delay = function() {
      ...
      t.AudioNode.call(this), this._delayNode = this.input = this.output = this.context.createDelay(this.toSeconds(e.maxDelay)), this.delayTime = new t.Param({
    ...
    function e(t) {
      return function(e, i) {
        var n, s, o;
        return i = this.toSeconds(i), t.apply(this, arguments), n = this._events.get(i), s = this._events.previousEvent(n), o = this._getTickUntilEvent(s, i - this.sampleTime), n.ticks = Math.max(o, 0), this
      }
    }
    return t.TickSignal = function(e) {
      e = t.defaultArg(e, 1), t.TimelineSignal.call(this, {
        units: t.Type.Ticks,
        value: e
      }), this._events.memory = 1 / 0
    }, t.extend(t.TickSignal, t.TimelineSignal), t.TickSignal.prototype.setValueAtTime = e(t.TimelineSignal.prototype.setValueAtTime), t.TickSignal.prototype.linearRampToValueAtTime = e(t.TimelineSignal.prototype.linearRampToValueAtTime), t.TickSignal.prototype.setTargetAtTime = function(t, e, i) {
      var n, s, o, r, a;
      for (e = this.toSeconds(e), this.setRampPoint(e), t = this._fromUnits(t), n = this._events.get(e), s = 5, o = 0; o <= s; o++) r = i * o + e, a = this._exponentialApproach(n.time, n.value, t, i, r), this.linearRampToValueAtTime(this._toUnits(a), r);
      return this
      ...
      for (e = this.toSeconds(e), t = this._fromUnits(t), i = this._events.get(e), null === i && (i = {
          value: this._initial,
          time: 0
        }), n = 5, s = (e - i.time) / n, o = 0; o <= n; o++) r = s * o + i.time, a = this._exponentialInterpolate(i.time, i.value, e, t, r), this.linearRampToValueAtTime(this._toUnits(a), r);
      return this
      ...
      return null === t && (t = {
        ticks: 0,
        time: 0
      }), i = this.getValueAtTime(t.time), n = this.getValueAtTime(e), .5 * (e - t.time) * (i + n) + t.ticks
      ...
      var i, n, s, o, r, a, l = this._events.get(e, "ticks"),
        h = this._events.getAfter(e, "ticks");
      return l && l.ticks === e ? l.time : l && h && h.type === t.TimelineSignal.Type.Linear && l.value !== h.value ? (i = this.getValueAtTime(l.time), n = this.getValueAtTime(h.time), s = (n - i) / (h.time - l.time), o = Math.sqrt(Math.pow(i, 2) - 2 * s * (l.ticks - e)), r = (-i + o) / s, a = (-i - o) / s, (r > 0 ? r : a) + l.time) : l ? 0 === l.value ? 1 / 0 : l.time + (e - l.ticks) / l.value : e / this._initial
    }, t.TickSignal
  }), t(function(t) {
    ...
    return t.Clock = function() {
      ...
      return e = this.toSeconds(e), this._state.getValueAtTime(e) !== t.State.Started && (this._state.setStateAtTime(t.State.Started, e), this._state.get(e).offset = i), this
      ...
      var e, i = this.now() + this.context.updateInterval,
        n = this._state.get(i);
      if (n) {
        if (n.state !== this._lastState) switch (this._lastState = n.state, n.state) {
          case t.State.Started:
            t.isUndef(n.offset) || (this.ticks = n.offset), this._nextTick = n.time, this.emit("start", n.time, this.ticks);
            break;
        ...
        for (; i > this._nextTick && this._state;)
          if (e = this._nextTick, this.frequency && (this._nextTick += this.frequency.getDurationOfTicks(1, this._nextTick), n.state === t.State.Started)) try {
    ...
    return t.TransportEvent = function(e, i) {
      i = t.defaultArg(i, t.TransportEvent.defaults), t.call(this), this.Transport = e, this.id = t.TransportEvent._eventId++, this.time = i.time, this.callback = i.callback, this._once = i.once
      ...
      return t.prototype.dispose.call(this), this.Transport = null, this.callback = null, this
    }, t.TransportEvent
  }), t(function(t) {
    return t.TransportRepeatEvent = function(e, i) {
      t.TransportEvent.call(this, e, i), i = t.defaultArg(i, t.TransportRepeatEvent.defaults), this.duration = i.duration, this._interval = i.interval, this._currentId = -1, this._nextId = -1, this._nextTick = this.time, this._boundRestart = this._restart.bind(this), this.Transport.on("start loopStart", this._boundRestart), this._restart()
      ...
      this._createEvents(), t.TransportEvent.prototype.invoke.call(this, e)
    }, t.TransportRepeatEvent.prototype._createEvents = function() {
      var e = this.Transport.ticks;
      e >= this.time && e >= this._nextTick && this._nextTick + this._interval < this.time + this.duration && (this._nextTick += this._interval, this._currentId = this._nextId, this._nextId = this.Transport.scheduleOnce(this.invoke.bind(this), t.TransportTime(this._nextTick, "i")))
    }, t.TransportRepeatEvent.prototype._restart = function() {
      this.Transport.clear(this._currentId), this.Transport.clear(this._nextId);
      var e = this.Transport.ticks;
      this._nextTick = this.time, e > this.time && (this._nextTick = this.time + Math.ceil((e - this.time) / this._interval) * this._interval), this._currentId = this.Transport.scheduleOnce(this.invoke.bind(this), t.TransportTime(this._nextTick, "i")), this._nextTick += this._interval, this._nextId = this.Transport.scheduleOnce(this.invoke.bind(this), t.TransportTime(this._nextTick, "i"))
    }, t.TransportRepeatEvent.prototype.dispose = function() {
      return this.Transport.clear(this._currentId), this.Transport.clear(this._nextId), this.Transport.off("start loopStart", this._boundRestart), this._boundCreateEvents = null, t.TransportEvent.prototype.dispose.call(this), this
    ...
    t.Transport = function() {
      ...
      var o = new t.TransportRepeatEvent(this, {
        ...
        time: this.toTicks(n),
        duration: this.toTicks(t.defaultArg(s, 1 / 0))
      });
      ...
      return e = t.defaultArg(e, 0), e = this.toTicks(e), this._timeline.cancel(e), this._repeatedEvents.cancel(e), this
      ...
      return t.isUndef(i) || (i = this.toTicks(i)), this._clock.start(e, i), this
      ...
      var i, n, s;
      return e = this.toSeconds(e), this.state !== t.State.Started ? 0 : (i = this._clock._nextTick, n = t.Time(this.ticks, "i"), s = e - n % e, 0 === s && (s = e), i + s)
    ...
    return t.Source = function(e) {
      ...
      var s, o;
      return e = t.isUndef(e) && this._synced ? t.Transport.seconds : this.toSeconds(e), this.retrigger || this._state.getValueAtTime(e) !== t.State.Started || this.stop(e), this._state.setStateAtTime(t.State.Started, e), this._synced ? (s = this._state.get(e), s.offset = t.defaultArg(i, 0), s.duration = n, o = t.Transport.schedule(function(t) {
        this._start(t, i, n)
      }.bind(this), e), this._scheduled.push(o)) : this._start.apply(this, arguments), this
    }, t.Source.prototype.stop = function(e) {
      if (e = t.isUndef(e) && this._synced ? t.Transport.seconds : this.toSeconds(e), this._state.cancel(e), this._state.setStateAtTime(t.State.Stopped, e), this._synced) {
    ...
    return window.OscillatorNode && !OscillatorNode.prototype.start && (OscillatorNode.prototype.start = OscillatorNode.prototype.noteOn, OscillatorNode.prototype.stop = OscillatorNode.prototype.noteOff, OscillatorNode.prototype.setPeriodicWave || (OscillatorNode.prototype.setPeriodicWave = OscillatorNode.prototype.setWaveTable), AudioContext.prototype.createPeriodicWave || (AudioContext.prototype.createPeriodicWave = AudioContext.prototype.createWaveTable)), t.Oscillator = function() {
      ...
      this._oscillator = this.context.createOscillator(), this._oscillator.setPeriodicWave(this._wave), this._oscillator.connect(this.output), this.frequency.connect(this._oscillator.frequency), this.detune.connect(this._oscillator.detune), e = this.toSeconds(e), t.isPast(e), this._oscillator.start(e)
    }, t.Oscillator.prototype._stop = function(e) {
      return this._oscillator && (e = this.toSeconds(e), t.isPast(e), this._oscillator.stop(e), this._oscillator = null), this
      ...
      var n, s, o, r, a = 4096,
        ...
        c = 1;
      for (e === t.Oscillator.Type.Custom ? (c = this._partials.length + 1, l = c) : (n = /^(sine|triangle|square|sawtooth)(\d+)$/.exec(e)) && (c = parseInt(n[2]) + 1, e = n[1], c = Math.max(c, 2), l = c), s = 1; s < l; ++s) {
        ...
        0 !== r ? (h[s] = -r * Math.sin(i * s), u[s] = r * Math.cos(i * s)) : (h[s] = 0, u[s] = 0)
      }
      return [h, u]
    ...
    return t.Mono = function() {
      t.AudioNode.call(this), this.createInsOuts(1, 0), this._merge = this.output = new t.Merge, this.input.connect(this._merge, 0, 0), this.input.connect(this._merge, 0, 1), this.input.gain.value = t.dbToGain(-10)
    ...
    return t.Panner = function(e) {
      t.AudioNode.call(this), t.Panner.hasStereoPanner ? (this._panner = this.input = this.output = this.context.createStereoPanner(), this.pan = this._panner.pan) : (this._crossFade = new t.CrossFade, this._merger = this.output = new t.Merge, this._splitter = this.input = new t.Split, this.pan = new t.Signal(0, t.Type.AudioRange), this._zero = new t.Zero, this._a2g = new t.AudioToGain, this._zero.connect(this._a2g), this.pan.chain(this._a2g, this._crossFade.fade), this._splitter.connect(this._crossFade, 0, 0), this._splitter.connect(this._crossFade, 1, 1), this._crossFade.a.connect(this._merger, 0, 0), this._crossFade.b.connect(this._merger, 0, 1)), this.pan.value = t.defaultArg(e, 0), this._readOnly("pan")
    }, t.extend(t.Panner, t.AudioNode), t.Panner.hasStereoPanner = t.context && t.isFunction(t.context.createStereoPanner), t.Panner.prototype.dispose = function() {
      return t.AudioNode.prototype.dispose.call(this), this._writable("pan"), t.Panner.hasStereoPanner ? (this._panner.disconnect(), this._panner = null, this.pan = null) : (this._zero.dispose(), this._zero = null, this._crossFade.dispose(), this._crossFade = null, this._splitter.dispose(), this._splitter = null, this._merger.dispose(), this._merger = null, this.pan.dispose(), this.pan = null, this._a2g.dispose(), this._a2g = null), this
    }, t.Panner
  }), t(function(t) {
    ...
    return window.AudioBuffer && !AudioBuffer.prototype.copyToChannel && (AudioBuffer.prototype.copyToChannel = function(t, e, i) {
      ...
      if (i = t.defaultArg(i, t.noOp), r = e.match(/\[(.+\|?)+\]$/)) {
        for (a = r[1].split("|"), l = a[0], h = 0; h < a.length; h++)
      ...
      return u = new XMLHttpRequest, u.open("GET", t.Buffer.baseUrl + e, !0), u.responseType = "arraybuffer", u.progress = 0, t.Buffer._downloadQueue.push(u), u.addEventListener("load", function() {
        200 === u.status ? t.context.decodeAudioData(u.response, function(e) {
    ...
    return t.Offline = function(e, i) {
      var n, s = t.context.sampleRate,
        o = t.context,
        r = new t.OfflineContext(2, i, s);
      return t.context = r, e(t.Transport), n = r.render(), t.context = o, n.then(function(e) {
    ...
    return t.Convolver = function() {
      ...
      t.Effect.call(this, e), this._convolver = this.context.createConvolver(), this._buffer = new t.Buffer, t.isString(e.url) ? this._buffer.load(e.url, function(t) {
    ...
    return t.Freeverb = function() {
      var n, s, o, r, a, l, h = t.defaults(arguments, ["roomSize", "dampening"], t.Freeverb);
      for (t.StereoEffect.call(this, h), this.roomSize = new t.Signal(h.roomSize, t.Type.NormalRange), this.dampening = new t.Signal(h.dampening, t.Type.Frequency), this._combFilters = [], this._allpassFiltersL = [], this._allpassFiltersR = [], n = 0; n < i.length; n++) s = this.context.createBiquadFilter(), s.type = "allpass", s.frequency.value = i[n], this._allpassFiltersL.push(s);
    ...
    return t.JCReverb = function() {
      var s, o, r, a, l = t.defaults(arguments, ["roomSize"], t.JCReverb);
      for (t.StereoEffect.call(this, l), this.roomSize = new t.Signal(l.roomSize, t.Type.NormalRange), this._scaleRoomSize = new t.Scale(-.733, .197), this._allpassFilters = [], this._feedbackCombFilters = [], s = 0; s < n.length; s++) o = this.context.createBiquadFilter(), o.type = "allpass", o.frequency.value = n[s], this._allpassFilters.push(o);
    ...
    return t.PitchShift = function() {
      ...
      set: function(e) {
        ...
        e < 0 ? (this._lfoA.min = 0,
          this._lfoA.max = this._windowSize, this._lfoB.min = 0, this._lfoB.max = this._windowSize, i = t.intervalToFrequencyRatio(e - 1) + 1) : (this._lfoA.min = this._windowSize, this._lfoA.max = 0, this._lfoB.min = this._windowSize, this._lfoB.max = 0, i = t.intervalToFrequencyRatio(e) - 1), this._frequency.value = i * (1.2 / this._windowSize)
      }
    ...
    return t.Part = function() {
      ...
      var n, s, o;
      for (e = t.TransportTime(e), n = t.Time(1, "i").toSeconds(), s = 0; s < this._events.length; s++)
        if (o = this._events[s], Math.abs(e.toTicks() - o.startOffset) < n) return t.isUndef(i) || (o.value = i), o;
      return t.isUndef(i) ? null : (this.add(e, i), this._events[this._events.length - 1])
      ...
      var n, s;
      for (e.hasOwnProperty("time") && (i = e, e = i.time), e = this.toTicks(e), n = this._events.length - 1; n >= 0; n--) s = this._events[n], s instanceof t.Part ? s.remove(e, i) : s.startOffset === e && (t.isUndef(i) || !t.isUndef(i) && s.value === i) && (this._events.splice(n, 1), s.dispose());
      return this
    ...
    return t.Sequence = function() {
      var e, i = t.defaults(arguments, ["callback", "events", "subdivision"], t.Sequence),
        n = i.events;
      if (delete i.events, t.Part.call(this, i), this._subdivision = this.toTicks(i.subdivision), t.isUndef(i.loopEnd) && !t.isUndef(n) && (this._loopEnd = n.length * this._subdivision), this._loop = !0, !t.isUndef(n))
      ...
      set: function(e) {
        ...
        if (e = Math.max(e, 1), this._oscillators.length !== e) {
          for (this._forEach(function(t) {
              t.dispose()
            }), this._oscillators = [], i = 0; i < e; i++) n = new t.Oscillator, this.type === t.Oscillator.Type.Custom ? n.partials = this._partials : n.type = this._type, n.phase = this._phase, n.volume.value = -6 - e, this.frequency.connect(n.frequency), this.detune.connect(n.detune), n.connect(this.output), this._oscillators[i] = n;
    ...
    return t.Instrument = function(e) {
      e = t.defaultArg(e, t.Instrument.defaults), t.AudioNode.call(this), this._volume = this.output = new t.Volume(e.volume), this.volume = this._volume.volume, this._readOnly("volume")
      ...
      return t.AudioNode.prototype.dispose.call(this), this._volume.dispose(), this._volume = null, this._writable(["volume"]), this.volume = null, this
    }, t.Instrument
  }), t(function(t) {
    return t.Monophonic = function(e) {
      ...
      var i, n;
      return e = this.toSeconds(e), this.portamento > 0 ? (i = this.frequency.value, this.frequency.setValueAtTime(i, e), n = this.toSeconds(this.portamento), this.frequency.exponentialRampToValueAtTime(t, e + n)) : this.frequency.setValueAtTime(t, e), this
    }, t.Monophonic
  }), t(function(t) {
    ...
    return t.MetalSynth = function(i) {
      ...
      }), s.connect(this._highpass).start(), this._oscillators[n] = s, o = new t.Multiply(e[n]), this._freqMultipliers[n] = o, this.frequency.chain(o, s.frequency);
      ...
      return e = this.toSeconds(e), i = t.defaultArg(i, 1), this.envelope.triggerAttack(e, i), this
    ...
    return window.AudioBufferSourceNode && !AudioBufferSourceNode.prototype.start && (AudioBufferSourceNode.prototype.start = AudioBufferSourceNode.prototype.noteGrainOn, AudioBufferSourceNode.prototype.stop = AudioBufferSourceNode.prototype.noteOff), t.BufferSource = function() {
      ...
      t.AudioNode.call(this), this.onended = e.onended, this._startTime = -1, this._stopTime = -1, this._gainNode = this.output = new t.Gain, this._source = this.context.createBufferSource(), this._source.connect(this._gainNode), this._buffer = new t.Buffer(e.buffer, e.onload), this.playbackRate = new t.Param(this._source.playbackRate, t.Type.Positive), this.fadeIn = e.fadeIn, this.fadeOut = e.fadeOut, this.curve = e.curve, this._gain = 1, this._onendedTimeout = -1, this.loop = e.loop, this.loopStart = e.loopStart, this.loopEnd = e.loopEnd, this.playbackRate.value = e.playbackRate
      ...
      return t.AudioNode.prototype.dispose.call(this), this.onended = null, this._source.disconnect(), this._source = null, this._gainNode.dispose(), this._gainNode = null, this._buffer.dispose(), this._buffer = null, this._startTime = -1, this.playbackRate = null, t.context.clearTimeout(this._onendedTimeout), this
    }, t.BufferSource
  }), t(function(t) {
    function e() {
    ...
    return t.Noise = function() {
      ...
      pink: function() {
        var t, e, s, o, r, a, l, h, u, c, p, f = [];
        for (t = 0; t < n; t++)
          for (e = new Float32Array(i), f[t] = e, s = o = r = a = l = h = u = 0, c = 0; c < i; c++) p = 2 * Math.random() - 1, s = .99886 * s + .0555179 * p, o = .99332 * o + .0750759 * p, r = .969 * r + .153852 * p, a = .8665 * a + .3104856 * p, l = .55 * l + .5329522 * p, h = -.7616 * h - .016898 * p, e[c] = s + o + r + a + l + h + u + .5362 * p, e[c] *= .11, u = .115926 * p;
        return f
      }(),
      brown: function() {
        var t, e, s, o, r, a = [];
    ...
    return t.NoiseSynth = function(e) {
      e = t.defaultArg(e, t.NoiseSynth.defaults), t.Instrument.call(this, e), this.noise = new t.Noise, this.envelope = new t.AmplitudeEnvelope(e.envelope), this.noise.chain(this.envelope, this.output), this.noise.start(), this._readOnly(["noise", "envelope"])
    ...
    return t.PolySynth = function() {
      ...
      for (Array.isArray(t) || (t = [t]), e = this.toSeconds(e), n = 0; n < t.length; n++) {
        for (s = t[n], o = this._triggers[0], 0, r = 1; r < this._triggers.length; r++) this._triggers[r].release < o.release && (o = this._triggers[r], r);
    ...
    return t.Sampler = function(e) {
      ...
      return null !== l && (s = a - l, o = this._buffers.get(s), r = new t.BufferSource({
        buffer: o,
      ...
      this._activeSources[s] && this._activeSources[s].length && (n = this._activeSources[s].shift().source, i = this.toSeconds(i), n.stop(i + this.release, this.release))
    ...
    return t.TransportTimelineSignal = function() {
        t.TimelineSignal.apply(this, arguments), this.output = this._outputSig = new t.Signal(this._initial), this._lastVal = this.value, this._synced = t.Transport.scheduleRepeat(this._onTick.bind(this), "1i"), this._bindAnchorValue = this._anchorValue.bind(this), t.Transport.on("start stop pause", this._bindAnchorValue), this._events.memory = 1 / 0
      }, t.extend(t.TransportTimelineSignal, t.TimelineSignal), t.TransportTimelineSignal.prototype._onTick = function(e) {
      ...
      t.TransportTimelineSignal.prototype.getValueAtTime = function(e) {
        return e = this.toTicks(e), t.TimelineSignal.prototype.getValueAtTime.call(this, e)
      }, t.TransportTimelineSignal.prototype.setValueAtTime = function(e, i) {
        return i = this.toTicks(i), t.TimelineSignal.prototype.setValueAtTime.call(this, e, i), this
      }, t.TransportTimelineSignal.prototype.linearRampToValueAtTime = function(e, i) {
        return i = this.toTicks(i), t.TimelineSignal.prototype.linearRampToValueAtTime.call(this, e, i), this
      }, t.TransportTimelineSignal.prototype.exponentialRampToValueAtTime = function(e, i) {
        return i = this.toTicks(i), t.TimelineSignal.prototype.exponentialRampToValueAtTime.call(this, e, i), this
      }, t.TransportTimelineSignal.prototype.setTargetAtTime = function(e, i, n) {
        return i = this.toTicks(i), t.TimelineSignal.prototype.setTargetAtTime.call(this, e, i, n), this
      }, t.TransportTimelineSignal.prototype.cancelScheduledValues = function(e) {
        return e = this.toTicks(e), t.TimelineSignal.prototype.cancelScheduledValues.call(this, e), this
      }, t.TransportTimelineSignal.prototype.setValueCurveAtTime = function(e, i, n, s) {
        return i = this.toTicks(i), n = this.toTicks(n), t.TimelineSignal.prototype.setValueCurveAtTime.call(this, e, i, n, s), this
      }, t.TransportTimelineSignal.prototype.dispose = function() {
        t.Transport.clear(this._synced), t.Transport.off("start stop pause", this._syncedCallback), this._events.cancel(0), t.TimelineSignal.prototype.dispose.call(this), this._outputSig.dispose(), this._outputSig = null
      }, t.TransportTimelineSignal
  }), t(function(t) {
    return t.MultiPlayer = function(e) {
      console.warn("Tone.MultiPlayer is deprecated. Use Tone.Players instead."), 1 !== arguments.length || t.isUndef(arguments[0]) || arguments[0].hasOwnProperty("urls") || (e = {
        urls: e
      });
      var i = t.defaults(arguments, ["urls", "onload"], t.MultiPlayer);
      t.Source.call(this, i), i.urls instanceof t.Buffers ? this.buffers = i.urls : this.buffers = new t.Buffers(i.urls, i.onload), this._activeSources = {}, this.fadeIn = i.fadeIn, this.fadeOut = i.fadeOut
      ...
      var i, n;
      return t.isString(e) || t.isNumber(e) ? i = this.buffers.get(e).get() : e instanceof t.Buffer ? i = e.get() : e instanceof AudioBuffer && (i = e), n = new t.BufferSource(i).connect(this.output), this._activeSources.hasOwnProperty(e) || (this._activeSources[e] = []), this._activeSources[e].push(n), n
    }, t.MultiPlayer.prototype.start = function(e, i, n, s, o, r) {
      i = this.toSeconds(i);
      var a = this._makeSource(e);
      return a.start(i, n, s, t.defaultArg(r, 1), this.fadeIn), s && a.stop(i + this.toSeconds(s), this.fadeOut), o = t.defaultArg(o, 0), a.playbackRate.value = t.intervalToFrequencyRatio(o), this
    }, t.MultiPlayer.prototype.startLoop = function(e, i, n, s, o, r, a) {
      i = this.toSeconds(i);
      var l = this._makeSource(e);
      return l.loop = !0, l.loopStart = this.toSeconds(t.defaultArg(s, 0)), l.loopEnd = this.toSeconds(t.defaultArg(o, 0)), l.start(i, n, void 0, t.defaultArg(a, 1), this.fadeIn), r = t.defaultArg(r, 0), l.playbackRate.value = t.intervalToFrequencyRatio(r), this
      ...
      for (e in this._activeSources)
        for (i = this._activeSources[e], n = 0; n < i.length; n++) i[n].stop(t);
      return this
    ...
    return t.Player = function(e) {
      var i;
      e instanceof t.Buffer ? (e = e.get(), i = t.Player.defaults) : i = t.defaults(arguments, ["url", "onload"], t.Player), t.Source.call(this, i), this._source = null, this.autostart = i.autostart, this._buffer = new t.Buffer({
        url: i.url,
        onload: this._onload.bind(this, i.onload),
        reverse: i.reverse
      }), e instanceof AudioBuffer && this._buffer.set(e), this._loop = i.loop, this._loopStart = i.loopStart, this._loopEnd = i.loopEnd, this._playbackRate = i.playbackRate, this.retrigger = i.retrigger, this.fadeIn = i.fadeIn, this.fadeOut = i.fadeOut
      ...
      return i = this._loop ? t.defaultArg(i, this._loopStart) : t.defaultArg(i, 0), i = this.toSeconds(i), n = t.defaultArg(n, Math.max(this._buffer.duration - i, 0)), n = this.toSeconds(n), e = this.toSeconds(e), this._source = new t.BufferSource({
        buffer: this._buffer,
        loop: this._loop,
        loopStart: this._loopStart,
        loopEnd: this._loopEnd,
      ...
      }).connect(this.output), this._loop || this._synced || this._state.setStateAtTime(t.State.Stopped, e + n), this._loop ? this._source.start(e, i) : this._source.start(e, i, n), this
    }, t.Player.prototype._stop = function(t) {
      return this._source && this._source.stop(this.toSeconds(t)), this
    ...
    return t.UserMedia = function() {
      ...
      return e = t.defaultArg(e, "default"), t.UserMedia.enumerateDevices().then(function(i) {
        var n, s;
